...
public class MainActivity extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView,int selectedBoxPosition)
    {
        ...
        if(playerTurn==1) {
            imageView.setImageResource(R.drawable.cross_game);
            ...
            imageView.setImageResource(R.drawable.circle_game);
            if(checkPlayerWin())
            {
    ...
    private void changePlayerTurn(int currentPlayerTurn)
    {
        ...
        if (playerTurn == 1)
        {
            ...
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_dark_black);
        }
        else {
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_black_border);
            playerOneLayout.setBackgroundResource(R.drawable.round_back_dark_black);
        }
    }
